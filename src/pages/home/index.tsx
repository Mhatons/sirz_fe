...
import VideoAnalysis from "../../components/videoAnlysis";
    ...
    return (
        <div className="sm:pt-40 pt-24">
            ...
            <div
                ...
                id="cardSection"
                className={`${visibleSections.includes("cardSection")
            ...
            <div
                ...
                id="aboutSection"
                className={`${visibleSections.includes("aboutSection")
                    ? "opacity-100 translate-y-0"
                    : "opacity-0 translate-y-10"
            ...
            <section
                ...
                id="journeySection"
                className={`${visibleSections.includes("journeySection")
                    ? "opacity-100 translate-y-0"
                    : "opacity-0 translate-y-10"
            ...
            <div className="pt-14">
                <CalculateProfit />
                <div className="sm:flex items-start gap-4 sm:w-[95%] pb-8 mt-16 m-auto">
