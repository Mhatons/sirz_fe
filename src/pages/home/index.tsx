...
export default function Home() {
    ...
    return (
        <div className="bg-white sm:pt-40 pt-10">
            <Hero />
            ...
            <div id="about" className=" sm:text-[22px] text-[17px] text-center shadow-lg mb-6 rounded-2xl font-semibold sm:px-20 px-5 py-10 sm:w-[75%] m-auto">
            ...
            <div className="bg-gray-100 py-8">
                ...
                <section className="bg-[#006881] mt-20 py-8 ">
                ...
                <section className="flex items-center justify-center flex-col py-10">
                    <header className="sm:text-[35px] text-[25px] max-sm:text-center font-exo font-bold text-[#196BB6] pb-10">Start your journey towards your financial freedom in 4 simple steps:</header>
